...
function StatCard({ value, label, delay }) {
  ...
  return (
    ...
    >
      <div className="font-serif text-4xl text-aqua font-semibold mb-1">
        {value}
      </div>
      <div className="font-mono text-xs text-parchment/65 tracking-widest uppercase">
        {label}
      </div>
    </motion.div>
  );
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10">
        ...
        <div>
          ...
          <motion.div
            ...
            className="space-y-5 text-parchment/80 leading-relaxed font-sans text-sm"
          >
            <p>{personalInfo.bio}</p>
            <p>
              Over 3 years at Experion Technologies, I've shipped solutions
              across sustainability (ESG platforms with GRI/SASB/TCFD
              compliance), mobility (EV charging apps), and HR tech — always
          ...
          >
            <div className="flex items-center gap-2 text-parchment/65 font-mono text-xs">
              <MapPin size={12} className="text-aqua" />
              {personalInfo.location}
            </div>
            <div className="flex items-center gap-2 font-mono text-xs">
              <span className="w-1.5 h-1.5 rounded-full bg-aqua animate-pulse" />
              <span className="text-aqua/90">{personalInfo.availability}</span>
            </div>
          </motion.div>
        </div>
        ...
        <div className="space-y-6">
          ...
          >
            <p className="section-label mb-6 mt-12">Education</p>
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="mt-1 w-8 h-8 border border-aqua/20 flex items-center justify-center flex-shrink-0 group-hover:border-aqua/50 transition-colors">
                    <GraduationCap size={14} className="text-aqua" />
                  </div>
                  <div>
                    <h3 className="font-serif text-parchment text-lg font-semibold leading-tight mb-1">
                      {edu.degree}
                    </h3>
                    <p className="font-mono text-xs text-aqua tracking-wider mb-1">
                      {edu.institution}
                    </p>
